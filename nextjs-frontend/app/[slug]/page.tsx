          ...
          <aside className="lg:sticky lg:top-8 hidden lg:block">
            ...
            <div className="bg-[#1a1a1a] p-6 rounded-lg border-2 border-[#2a2a2a]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://freeaigenerator.co/${params.slug}`)}&text=${encodeURIComponent(title)}`}
                   target="_blank"
                ...
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://freeaigenerator.co/${params.slug}`)}`}
                   target="_blank"
                   rel="noopener noreferrer"
                   className="flex items-center justify-center h-11 rounded-lg bg-[#2a2a2a] border border-[#3a3a3a] text-[#9ca3af] hover:bg-[#ef4444] hover:border-[#ef4444] hover:text-white hover:-translate-y-0.5 transition-all"
                ...
                <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://freeaigenerator.co/${params.slug}`)}`}
                   target="_blank"
                   rel="noopener noreferrer"
                   className="flex items-center justify-center h-11 rounded-lg bg-[#2a2a2a] border border-[#3a3a3a] text-[#9ca3af] hover:bg-[#ef4444] hover:border-[#ef4444] hover:text-white hover:-translate-y-0.5 transition-all"
                ...
                <a href={`https://reddit.com/submit?url=${encodeURIComponent(`https://freeaigenerator.co/${params.slug}`)}&title=${encodeURIComponent(title)}`}
                   target="_blank"
                   rel="noopener noreferrer"
                   className="flex items-center justify-center h-11 rounded-lg bg-[#2a2a2a] border border-[#3a3a3a] text-[#9ca3af] hover:bg-[#ef4444] hover:border-[#ef4444] hover:text-white hover:-translate-y-0.5 transition-all"
